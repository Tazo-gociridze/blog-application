  ...
  return (
    <div className="header-tools flex items-center gap-[20px] *:cursor-pointer">
      ...
      <div className="relative text-[14px]">
        ...
        <div
          className={
            `absolute right-[0px] top-[40px] h-[100px] w-[100px] gap-[30px] rounded-xl
            border-[1px] border-[#706b6b2a] bg-[#464444] p-[10px] text-[white] shadow-xl ${langDropdown ? 'flex-col' : 'hidden'}` 
          }
        >
